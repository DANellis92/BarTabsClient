...
function loop() {
  ...
  turbs[turbsIndex] = turbulence; // loop backwards through all points BEFORE turbsIndex
  ...
  length = points.length; // loop forward through all points AFTER turbsIndex
...
function init() {
  ...
  document.body.style.cssText =
    "margin:0;padding:0;overflow:hidden;background:#eb8a00;background-image:radial-gradient(circle, #ffb900, #da5900);background-size:";
